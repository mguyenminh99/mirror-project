    ...
    return Collection.extend({
        defaults: {
            ...
            templates: {
                filters: {
                    ...
                    customTextRange: {
                        component: 'Mpx_Backend/js/grid/filters/customTextRange',
                        rangeType: 'text'
                    },
                    customDateRange: {
                        component: 'Mpx_Backend/js/grid/filters/customDateRange',
                        rangeType: 'date'
                    }
                }
            },
        ...
        initialize: function () {
            ...
            if (sessionStorage.getItem('filtered')) {
                var filtered = JSON.parse(sessionStorage.getItem('filtered'));
                this.set('applied', filtered);
            }
            this.applyFilter();
        ...
        applyFilter: function () {
            ...
            if (searchParams.has('order_id')) {
                var orderId = searchParams.get('order_id').replace('/','');
                var filter = {
                    'increment_order_id' : orderId,
                    'placeholder': true
                };
                this.set('applied', removeEmpty(filter));
            }
        },
        ...
        apply: function () {
            ...
            sessionStorage.setItem('filtered', JSON.stringify(this.filters));
            return this;
        },
