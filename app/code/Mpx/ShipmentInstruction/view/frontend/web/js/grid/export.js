...
], function ($, _, Element, modal, Export) {
    'use strict';
    ...
    return Element.extend({
        ...
        getParams: function () {
            ...
            if (data) {
                ...
                result.delivery_format = $('select[name=delivery_format]').val();
                result.csv_format = $('select[name=csv_format]').val();
                result.estimated_ship_date = $('input[name=estimated_ship_date]').val();
        ...
        /**
         * Show export csv detail modal
         */
        showModal: function () {
            let self = this,
                options = {
                type: 'popup',
                title: 'CSV detail settings',
                responsive: false,
                buttons: [
                    {
                        text: $.mage.__('Cancel'),
            ...
            modal(options, $('#custom-export-modal'));
            $('#custom-export-modal').modal('openModal');
        },
    });
});
