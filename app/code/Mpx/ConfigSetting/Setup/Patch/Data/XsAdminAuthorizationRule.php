...
class XsAdminAuthorizationRule implements DataPatchInterface
{
    ...
    public function apply() {
        ...
        $resource=[
            ...
            'XShoppingSt_Marketplace::marketplace',
            'XShoppingSt_Marketplace::menu',
            'XShoppingSt_Marketplace::seller',
            'XShoppingSt_Mpshipping::menu',
            'XShoppingSt_Mpshipping::mpshipping',
            'XShoppingSt_Mpshipping::mpshippingset',
            'XShoppingSt_MpTimeDelivery::menu',
            'XShoppingSt_MpTimeDelivery::slots',
            'XShoppingSt_MpTimeDelivery::order',
            'Magento_Sales::sales',
