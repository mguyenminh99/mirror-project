<?php
namespace XShoppingSt\Mpshipping\Block\Adminhtml\Shipping\Edit\Tab;

use Magento\Backend\Block\Widget\Grid;
use Magento\Backend\Block\Widget\Grid\Column;
use Magento\Backend\Block\Widget\Grid\Extended;
use XShoppingSt\Mpshipping\Model\ResourceModel\Mpshipping\CollectionFactory;
...
class Shipping extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \XShoppingSt\Mpshipping\Model\ResourceModel\Mpshipping\CollectionFactory
     */
    protected $_mpshippingFactoryCollection;
    /**
     * @param \Magento\Backend\Block\Template\Context $context
     * @param \Magento\Backend\Helper\Data $backendHelper
     * @param \XShoppingSt\Mpshipping\Model\MpshippingFactory $shippingFactory
    ...
    public function __construct(
        ...
        \XShoppingSt\Mpshipping\Model\MpshippingFactory $shippingFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter'    =>  false,
                'index' => 'customer_name',
                'renderer'  => \XShoppingSt\Mpshipping\Block\Adminhtml\Shipping\Grid\Rendername::class,
            ]
        );
        $this->addColumn(
            'dest_country_id',
    ...
    {
        $this->getMassactionBlock()->setTemplate('XShoppingSt_Mpshipping::widget/grid/massaction_extended.phtml');
