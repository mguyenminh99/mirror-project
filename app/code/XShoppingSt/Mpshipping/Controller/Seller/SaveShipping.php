<?php
namespace XShoppingSt\Mpshipping\Controller\Seller;
...
/**
 * XShoppingSt Mpshipping SaveShipping Controller.
 */
class SaveShipping extends Action
{
     ...
     * @param  \XShoppingSt\Mpshipping\Model\SellerLocationFactory $sellerLocation
