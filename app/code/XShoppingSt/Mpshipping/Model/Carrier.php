...
use XShoppingSt\Mpshipping\Model\MpshippingsetFactory;
use Magento\Framework\Pricing\PriceCurrencyInterface;
use Magento\Customer\Model\CustomerFactory;
use Magento\Customer\Model\AddressFactory;
use XShoppingSt\MarketplaceBaseShipping\Model\ShippingSettingRepository;
use XShoppingSt\Mpshipping\Helper\Data as HelperData;
use XShoppingSt\Mpshipping\Model\MpshippingDistFactory;
use Magento\Framework\HTTP\Client\Curl;

class Carrier extends \XShoppingSt\MarketplaceBaseShipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
     ...
     * @var string
     */
    const CODE = 'x_shopping_st_shipping';
    /**
     * Code of the carrier.
     *
     * @var string
    ...
    public function __construct(
        ...
        \XShoppingSt\Mpshipping\Model\SellerLocationFactory $sellerLocation,
        array $data = []
    ) {
    ...
    {
        return ['x_shopping_st_shipping' => $this->_scopeConfig->getValue('carriers/x_shopping_st_shipping/title')];
    }
    /**
     ...
     * @param  float $weight
     * @return \XShoppingSt\Mpshipping\Model\Mpshipping $shipping
     */
     ...
     * @return \XShoppingSt\Mpshipping\Model\Mpshippingset $shipping
     */
