...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getMpshippingEnabled()
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/active',
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/title',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/name',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/allowadmin',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        if ($this->_moduleManager->isOutputEnabled("XShoppingSt_MpMultiShipping") &&
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/distance',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getGoogleApiKey()
    {
        $encryptApiKey = $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/google_api_key',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/x_shopping_st_shipping/distance_unit',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    /**
     ...
     *
     * @param int $sellerId
     * @return \XShoppingSt\Mpshipping\Model\SellerLocation
     */
