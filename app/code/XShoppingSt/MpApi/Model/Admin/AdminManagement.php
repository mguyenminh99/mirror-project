<?php
namespace XShoppingSt\MpApi\Model\Admin;

use Magento\Framework\Controller\ResultFactory;

class AdminManagement implements \XShoppingSt\MpApi\Api\AdminManagementInterface
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Model\OrdersFactory
     */
    protected $mpOrdersFactory;

    /**
     * @var \XShoppingSt\Marketplace\Model\Saleperpartner
     */
    protected $salesPerPartnerFactory;

    /**
     * @var \XShoppingSt\Marketplace\Model\SellertransactionFactory
     */
    protected $sellerTransactionsFactory;

    /**
     * @var \XShoppingSt\Marketplace\Helper\Email
     */
    protected $emailHelper;

    /**
     * @var \XShoppingSt\MpApi\Api\Data\ResponseInterface
     */
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\ResourceModel\Seller\CollectionFactory $sellerlistCollectionFactory,
        \Magento\Framework\App\RequestInterface $request,
        \Magento\Sales\Model\OrderRepository $orderRepository,
        \Magento\Framework\Stdlib\DateTime\DateTime $date,
        \XShoppingSt\Marketplace\Model\ResourceModel\Product\CollectionFactory $sellerProduct,
        ...
        \XShoppingSt\Marketplace\Model\OrdersFactory $mpOrdersFactory,
        \XShoppingSt\Marketplace\Model\SaleperpartnerFactory $salesPerPartnerFactory,
        \XShoppingSt\Marketplace\Model\SellertransactionFactory $sellerTransactionsFactory,
        \XShoppingSt\Marketplace\Helper\Email $emailHelper,
        \XShoppingSt\MpApi\Api\Data\ResponseInterface $responseApi
    ) {
