<?php
namespace XShoppingSt\MpApi\Model\ResourceModel\Saleslist;

use \XShoppingSt\MpApi\Api\Data\SellerResultsInterface;
use \XShoppingSt\MpApi\Model\ResourceModel\AbstractCollection;

/**
 * XShoppingSt MpApi ResourceModel Saleslist collection
 */
class Collection extends AbstractCollection implements SellerResultsInterface
{
    /**
     * @var string
     */
    ...
    {
        $this->_init(
            'XShoppingSt\Marketplace\Model\Saleslist',
            'XShoppingSt\Marketplace\Model\ResourceModel\Saleslist'
        );
    ...
    public function getSellerOrderTotal($limit = null, $offset = null)
    {
        ...
        $idsSelect->columns(
            [
                ...
                'SUM(mo.coupon_amount) AS coupon_amount',
