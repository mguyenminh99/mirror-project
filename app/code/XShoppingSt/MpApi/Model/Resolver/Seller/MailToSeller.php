...
class MailToSeller implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if (!isset($args['query']) || !isset($args['subject']) || !isset($args['customer_email']) || !isset($args['customer_name'])) {
            throw new GraphQlInputException(
                __("'query' & 'subject' & 'customer_email' & 'customer_name' input arguments are required.")
            );
        }
        $result = $this->sellerManagement->mailToSeller($context->getUserId());
