...
class BecomePartner implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if (!isset($args['shop_url']) || !isset($args['is_seller'])) {
            throw new GraphQlInputException(
                __("'shop_url' & 'is_seller' input arguments are required.")
            );
        }
        $result = $this->sellerManagement->becomePartner($context->getUserId());
