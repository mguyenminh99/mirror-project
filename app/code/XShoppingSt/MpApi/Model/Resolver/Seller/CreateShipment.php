...
class CreateShipment implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if (!isset($args['orderid']) || !isset($args['tracking_number']) || !isset($args['carrier'])) {
            throw new GraphQlInputException(
                __("'orderid' & 'tracking_number' & 'carrier' input arguments are required.")
            );
        }
        $result = $this->sellerManagement->ship($context->getUserId(), $args['orderid']);
