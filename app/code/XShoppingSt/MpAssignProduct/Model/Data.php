...
use XShoppingSt\MpAssignProduct\Api\Data\DataInterface;
...
class Data extends \Magento\Framework\Model\AbstractModel implements DataInterface, IdentityInterface
{
    ...
    {
        $this->_init(\XShoppingSt\MpAssignProduct\Model\ResourceModel\Data::class);
    }
     ...
     * Load No-Route Quote.
     *
     * @return \XShoppingSt\MpAssignProduct\Model\Data
     */
