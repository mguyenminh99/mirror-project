<?php
namespace XShoppingSt\MpAssignProduct\Block\Product\Helper\Form\Gallery;

use Magento\Catalog\Model\Product;

class Content extends \XShoppingSt\Marketplace\Block\Product\Helper\Form\Gallery\Content
{
    /**
