...
/**
 * XShoppingSt MassUpload Dataflow Profile Edit Controller.
 */
class Edit extends \XShoppingSt\MpMassUpload\Controller\Adminhtml\Dataflow\AbstractProfile
{
    /**
    ...
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock(
            \XShoppingSt\MpMassUpload\Block\Adminhtml\Dataflow\Profile::class
        );
