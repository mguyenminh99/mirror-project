...
class AttributeProfile extends AbstractModel implements AttributeProfileInterface, IdentityInterface
{
    ...
    {
        $this->_init(\XShoppingSt\MpMassUpload\Model\ResourceModel\AttributeProfile::class);
    }
     ...
     *
     * @return \XShoppingSt\MpMassUpload\Model\AttributeProfile
     */
     ...
     * @param int $id
     *
     * @return \XShoppingSt\MpMassUpload\Api\Data\AttributeProfileInterface
     */
