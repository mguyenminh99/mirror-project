<?php
namespace XShoppingSt\MpMassUpload\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Controller\Product\SaveProduct
     */
    ...
    /**
     * @var \XShoppingSt\MpMassUpload\Model\Zip
     */
    protected $_zip;
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_MpAttributeMapping')) {
            return true;
        }
        return false;
    }
     ...
     * @param int $sellerId
     *
     * @return XShoppingSt\Marketplace\Model\Seller object
     */
        ...
        if ($this->canSaveCustomAttribute()) {
            try {
                $collection = $this->_objectManager
                    ->create(\XShoppingSt\Customattribute\Model\ResourceModel\Manageattribute\Collection::class)
    ...
    public function canSaveCustomAttribute()
    {
        ...
        if ($this->_moduleManager->isEnabled('XShoppingSt_Customattribute') && $validateCustomAttribute) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_Customoption')) {
            return true;
        }
        return false;
    }
    ...
    {
        $sellerId = $this->getCustomerId();
        $sellerGroupHelper = $this->_objectManager->create(\XShoppingSt\MpSellerGroup\Helper\Data::class);
    ...
    public function isSellerMembershipEnable()
    {
        ...
        if ($this->_moduleManager->isEnabled('XShoppingSt_Mpmembership') && $isSellerMembershipEnabled) {
            return true;
        }
        return false;
    }
    ...
    public function getConfigFeeAppliedFor()
    {
        $sellerMembershipHelper = $this->_objectManager->create(
            \XShoppingSt\Mpmembership\Helper\Data::class
        );
