<?php
namespace XShoppingSt\MarketplaceBaseShipping\Controller\Shipment;
...
class PrintLabel extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $marketplaceOrder = $this->_objectManager->create(\XShoppingSt\Marketplace\Model\Orders::class)
                                    ->getCollection()
