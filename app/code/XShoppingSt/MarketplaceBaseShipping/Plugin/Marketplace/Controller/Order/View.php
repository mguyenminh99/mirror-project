<?php
namespace XShoppingSt\MarketplaceBaseShipping\Plugin\Marketplace\Controller\Order;
...
class View
{
    ...
    public function beforeExecute(\XShoppingSt\Marketplace\Controller\Order\View $subject)
    {
