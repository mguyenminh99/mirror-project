define([
    ...
    'XShoppingSt_Marketplace/js/advanced-pricing-handler',
    'XShoppingSt_Marketplace/js/options/price-type-handler',
    'collapsible',
    ...
    return {
         ...
         */
        'XShoppingSt_Marketplace/js/configurable-type-handler': function (data) {
