    ...
    'ko',
        ...
        return Component.extend({
            ...
            _showProductNotification: function (productData) {
                $('[data-ui-id="menu-x-shopping-st-marketplace-product"]').css('position','relative');
                $('[data-ui-id="menu-x-shopping-st-marketplace-product"]').css('padding-right', '50px');
                var data = {},
                    notifyTmp;
                ...
                $(notifyTmp)
                .appendTo($('[data-ui-id="menu-x-shopping-st-marketplace-product"]'));
            },
            _showSellerNotification: function (sellerData) {
                $('[data-ui-id="menu-x-shopping-st-marketplace-seller"]').css('position','relative');
                $('[data-ui-id="menu-x-shopping-st-marketplace-seller"]').css('position', '50px');
                var data = {},
                    notifyTmp;
                ...
                $(notifyTmp)
                .appendTo($('[data-ui-id="menu-x-shopping-st-marketplace-seller"]'));
            },
             _showFeedbackNotification: function (feedbackData) {
                $('[data-ui-id="menu-x-shopping-st-marketplace-feedback"]').css('position','relative');
                $('[data-ui-id="menu-x-shopping-st-marketplace-feedback"]').css('position', '50px');
                var data = {},
                    notifyTmp;
                ...
                $(notifyTmp)
                .appendTo($('[data-ui-id="menu-x-shopping-st-marketplace-feedback"]'));
            },
