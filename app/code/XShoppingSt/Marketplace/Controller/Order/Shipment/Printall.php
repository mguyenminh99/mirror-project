...
/**
 * XShoppingSt Marketplace Order Shipment Printall pdf Controller by date range.
 */
class Printall extends \XShoppingSt\Marketplace\Controller\Order
{
            ...
            try {
                ...
                if (!empty($shipmentIds)) {
                    ...
                    $pdf = $this->_objectManager->create(
                        \XShoppingSt\Marketplace\Model\Order\Pdf\Shipment::class
                    )->getPdf($shipments);
