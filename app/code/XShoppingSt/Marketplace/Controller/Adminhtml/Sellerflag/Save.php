<?php
namespace XShoppingSt\Marketplace\Controller\Adminhtml\Sellerflag;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Model\SellerFlagReasonFactory
     */
    protected $sellerFlagFactory;

    /**
     * @var \XShoppingSt\Marketplace\Api\SellerFlagReasonRepositoryInterface
     */
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\SellerFlagReasonFactory $sellerFlagFactory,
        \XShoppingSt\Marketplace\Api\SellerFlagReasonRepositoryInterface $sellerFlagRepository,
    ...
    {
        return $this->_authorization->isAllowed('XShoppingSt_Marketplace::sellerflag');
    }
}
