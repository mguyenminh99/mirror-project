<?php
namespace XShoppingSt\Marketplace\Controller\Adminhtml\Feedback;
...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('XShoppingSt_Marketplace::feedback');
     ...
     * @param   \XShoppingSt\Marketplace\Model\Feedback $collection
     */
    ...
    {
        return $this->_authorization->isAllowed('XShoppingSt_Marketplace::feedback');
    }
}
