...
use XShoppingSt\Marketplace\Model\ResourceModel\Saleperpartner\CollectionFactory as SalePerPartnerCollection;
use XShoppingSt\Marketplace\Model\ResourceModel\Saleslist\CollectionFactory as SalesListCollection;
use XShoppingSt\Marketplace\Model\ResourceModel\Orders\CollectionFactory as MpOrdersCollection;
use Magento\Sales\Model\Order\Payment\Transaction;

/**
 * XShoppingSt Marketplace Helper Payment.
 */
class Payment extends \Magento\Framework\App\Helper\AbstractHelper
{
        ...
        try {
            ...
            if ($mpAssignProductId) {
                $mpassignModel = $this->objectManager->create(
                    \XShoppingSt\MpAssignProduct\Model\Items::class
    ...
    public function getCreditPoints($sellerId)
    {
        $amount = 0;
        try {
            if ($this->_moduleManager->isEnabled('XShoppingSt_Mpsellercredits') && $sellerId !== '') {
