<?php
namespace XShoppingSt\Marketplace\Helper;
...
use XShoppingSt\Marketplace\Model\ResourceModel\Product\CollectionFactory as MpProductCollection;
use XShoppingSt\Marketplace\Model\ResourceModel\Feedback\CollectionFactory as MpFeedbackCollection;
...
/**
 * XShoppingSt Marketplace Helper Data.
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Logger\Logger
     */
    protected $logger;
     ...
     * @param \XShoppingSt\Marketplace\Model\Seller $marketplaceSeller
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\Seller $marketplaceSeller,
        \Magento\Indexer\Model\Indexer\CollectionFactory $indexerCollectionFactory,
        \Magento\Customer\Model\CustomerFactory $customerModel,
        Visibility $visibility,
        ControllersRepository $controllersRepository,
        UrlRewriteFactory $urlRewriteFactory,
        \XShoppingSt\Marketplace\Logger\Logger $logger
    ) {
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\ResourceModel\Seller\Collection
     */
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\ResourceModel\Product\Collection
     */
    ...
    public function getAllowedProductType()
    {
        ...
        foreach ($data as $key => $value) {
            if ($value == 'grouped') {
                if ($this->_moduleManager->isEnabled('XShoppingSt_MpGroupedProduct')) {
            ...
            if ($value == 'bundle') {
                if ($this->_moduleManager->isEnabled('XShoppingSt_MpBundleProduct')) {
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_MpSellerGroup')) {
            return true;
        }
        return false;
    }
    ...
    public function isAllowedAction($actionName = '')
    {
        if ($this->isSellerGroupModuleInstalled()) {
            $sellerGroupHelper = $this->_objectManager->create(
                \XShoppingSt\MpSellerGroup\Helper\Data::class
            );
            ...
            $sellerGroupTypeRepository = $this->_objectManager->create(
                \XShoppingSt\MpSellerGroup\Api\SellerGroupTypeRepositoryInterface::class
            );
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_MpSellerCoupons')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_Mpcashondelivery')) {
            return true;
        }
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_MpSellerProductSearch')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($this->_moduleManager->isEnabled('XShoppingSt_Mpsellerslider')) {
            return true;
        }
    ...
    protected function getSellerId($mpassignproductId, $proid)
    {
        ...
        if ($mpassignproductId) {
            $this->assignItemsFactory = ObjectManager::getInstance()->create(
                \XShoppingSt\MpAssignProduct\Model\ItemsFactory::class
            );
