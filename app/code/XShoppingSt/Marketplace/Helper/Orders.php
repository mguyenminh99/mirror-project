...
use XShoppingSt\Marketplace\Model\OrdersFactory as MpOrdersFactory;
...
use XShoppingSt\Marketplace\Model\FeedbackcountFactory;
...
class Orders extends \Magento\Framework\App\Helper\AbstractHelper
{
        ...
        if ($actparterprocost) {
            ...
            if ($uniqueId != '') {
                ...
                $this->notificationHelper->saveNotification(
                    \XShoppingSt\Marketplace\Model\Notification::TYPE_TRANSACTION,
                    $transid,
                    $transid
                );
            }
     ...
     *
     * @param \XShoppingSt\Marketplace\Model\Saleslist $res
     *
     * @return array
     */
