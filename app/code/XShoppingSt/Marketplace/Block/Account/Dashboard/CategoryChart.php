<?php
namespace XShoppingSt\Marketplace\Block\Account\Dashboard;
...
class CategoryChart extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Block\Account\Dashboard
     */
    protected $dashboard;

    /**
     * @var \XShoppingSt\Marketplace\Helper\Dashboard\Data
     */
     ...
     * @param \XShoppingSt\Marketplace\Block\Account\Dashboard $dashboard
     * @param \XShoppingSt\Marketplace\Helper\Dashboard\Data $dashboardHelper
     */
    public function __construct(
        \Magento\Customer\Model\Session $customerSession,
        \Magento\Framework\View\Element\Template\Context $context,
        \XShoppingSt\Marketplace\Block\Account\Dashboard $dashboard,
        \XShoppingSt\Marketplace\Helper\Dashboard\Data $dashboardHelper,
        array $data = []
    ) {
