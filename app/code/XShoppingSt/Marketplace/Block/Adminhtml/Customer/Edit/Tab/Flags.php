...
class Flags extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\ResourceModel\SellerFlags\CollectionFactory $flagsFactory,
        array $data = []
    ) {
    ...
    {
        /** @var $collection \XShoppingSt\Marketplace\Model\ResourceModel\SellerFlags\Collection */
