...
class Product extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \XShoppingSt\Marketplace\Block\Adminhtml\Customer\Edit\Tab\Grid\Product
     */
    protected $blockGrid;
     ...
     * @param \XShoppingSt\Marketplace\Model\ResourceModel\Product\Collection $sellerProduct
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\ResourceModel\Product\Collection $sellerProduct,
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \XShoppingSt\Marketplace\Block\Adminhtml\Customer\Edit\Tab\Grid\Product::class,
                'seller.product.grid'
            );
        }
