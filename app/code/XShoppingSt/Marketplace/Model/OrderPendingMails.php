...
use XShoppingSt\Marketplace\Api\Data\OrderPendingMailsInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace OrderPendingMails Model.
 *
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\OrderPendingMails _getResource()
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\OrderPendingMails getResource()
 */
class OrderPendingMails extends AbstractModel implements OrderPendingMailsInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\ResourceModel\OrderPendingMails::class
        );
    }
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\OrderPendingMails
     */
     ...
     * @param int $id
     *
     * @return \XShoppingSt\Marketplace\Api\Data\OrderPendingMailsInterface
     */
