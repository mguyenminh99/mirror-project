...
use XShoppingSt\Marketplace\Api\Data\FeedbackcountInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Feedbackcount Model.
 *
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Feedbackcount _getResource()
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Feedbackcount getResource()
 */
class Feedbackcount extends AbstractModel implements FeedbackcountInterface, IdentityInterface
{
    ...
    {
        $this->_init(\XShoppingSt\Marketplace\Model\ResourceModel\Feedbackcount::class);
    }
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\Feedbackcount
     */
