<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\Seller;
...
/**
 * XShoppingSt Marketplace ResourceModel Seller collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\Seller::class,
