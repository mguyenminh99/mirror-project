<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\OrderPendingMails;

use \XShoppingSt\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * XShoppingSt Marketplace ResourceModel OrderPendingMails collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\OrderPendingMails::class,
