<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\Notification;

use \XShoppingSt\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * XShoppingSt Marketplace ResourceModel Notification Collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\Notification::class,
