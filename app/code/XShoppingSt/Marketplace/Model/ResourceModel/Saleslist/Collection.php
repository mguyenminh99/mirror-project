<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\Saleslist;

use \XShoppingSt\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * XShoppingSt Marketplace ResourceModel Saleslist collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\Saleslist::class,
