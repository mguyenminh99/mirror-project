<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\Product;

use \XShoppingSt\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * XShoppingSt Marketplace ResourceModel product collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\Product::class,
