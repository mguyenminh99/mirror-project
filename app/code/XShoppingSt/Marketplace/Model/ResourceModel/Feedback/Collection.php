<?php
namespace XShoppingSt\Marketplace\Model\ResourceModel\Feedback;

use \XShoppingSt\Marketplace\Model\ResourceModel\AbstractCollection;
use Magento\Framework\DB\Select as DBSelect;

/**
 * XShoppingSt Marketplace ResourceModel Feedback collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\Feedback::class,
