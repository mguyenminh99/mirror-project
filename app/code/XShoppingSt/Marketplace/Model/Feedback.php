...
use XShoppingSt\Marketplace\Api\Data\FeedbackInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Feedback Model
 *
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Feedback _getResource()
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Feedback getResource()
 */
class Feedback extends AbstractModel implements FeedbackInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\ResourceModel\Feedback::class
        );
    }
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\Feedback
     */
