<?php
namespace XShoppingSt\Marketplace\Model\Notification;
...
class MarketplaceConfigProvider
{
    ...
    protected $productModel;
     ...
     /**
      * @var \XShoppingSt\Marketplace\Model\SellerFactory
      */
    ...
    protected $productFactory;
     ...
     /**
      * @var \XShoppingSt\Marketplace\Model\FeedbackFactory
      */
    ...
    public function __construct(
        ...
        \XShoppingSt\Marketplace\Model\ProductFactory $productModel,
        \XShoppingSt\Marketplace\Model\SellerFactory $sellerModel,
    ...
    public function getConfig()
    {
        if ($this->isAdminLoggedIn()) {
            $defaultImageUrl = $this->viewFileSystem->getUrlWithParams(
                'XShoppingSt_Marketplace::images/icons_notifications.png',
                []
            );
