...
use XShoppingSt\Marketplace\Api\Data\SellerInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Seller Model.
 *
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Seller _getResource()
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Seller getResource()
 */
class Seller extends AbstractModel implements SellerInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\ResourceModel\Seller::class
        );
    }
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\Seller
     */
