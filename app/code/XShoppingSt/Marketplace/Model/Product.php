...
use XShoppingSt\Marketplace\Api\Data\ProductInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Product Model.
 *
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Product _getResource()
 * @method \XShoppingSt\Marketplace\Model\ResourceModel\Product getResource()
 */
class Product extends AbstractModel implements ProductInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \XShoppingSt\Marketplace\Model\ResourceModel\Product::class
        );
    }
     ...
     *
     * @return \XShoppingSt\Marketplace\Model\Product
     */
     ...
     * @param int $id
     *
     * @return \XShoppingSt\Marketplace\Api\Data\ProductInterface
     */
