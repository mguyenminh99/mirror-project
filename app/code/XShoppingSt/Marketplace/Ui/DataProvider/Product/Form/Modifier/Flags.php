<?php
namespace XShoppingSt\Marketplace\Ui\DataProvider\Product\Form\Modifier;
...
class Flags extends AbstractModifier
{
    ...
    {
        if (!$this->locator->getProduct()->getId() || !$this->getModuleManager()->isOutputEnabled('XShoppingSt_Marketplace')) {
            return $meta;
        }
